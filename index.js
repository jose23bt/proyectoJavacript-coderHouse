...
if (validateUser(username, password)) {
    ...
    // Si el usuario no existe, se le pregunta si desea registrarse
    const register = confirm('Usuario o contraseña incorrectos. ¿Desea registrarse?');

    // Si el usuario quiere registrarse, se llama a la función registerUser()
    if (register) {
        registerUser();
    } else {
